...
def get_stick_entropy(vb_params_dict, gh_loc, gh_weights, use_logitnormal_sticks = True):
    ...
    if use_logitnormal_sticks:
        ...
        e_log_v, e_log_1mv =\
            ef.get_e_log_logitnormal(
                ...
                lognorm_infos = vb_params_dict['v_stick_info'],
                gh_loc = gh_loc,
...
def get_dp_prior(vb_params_dict, prior_params_dict,
...
def get_e_log_cluster_probabilities(vb_params_dict, gh_loc, gh_weights,
...
def loglik_ind(vb_params_dict, e_z, gh_loc, gh_weights,
                    use_logitnormal_sticks = True):
    assert np.all(gh_weights > 0)
    # expected log likelihood of all indicators for all n observations
    e_log_cluster_probs = get_e_log_cluster_probabilities(vb_params_dict,
                                gh_loc, gh_weights,
