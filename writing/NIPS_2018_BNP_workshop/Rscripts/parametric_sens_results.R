...
results_matrix_1 <- read.csv('./data_for_figures/init_alpha3_thresh0_param_sens.csv', header = FALSE)
...
results_matrix_2 <- read.csv('./data_for_figures/init_alpha8_thresh0_param_sens.csv', header = FALSE)
...
results_matrix_3 <- read.csv('./data_for_figures/init_alpha13_thresh0_param_sens.csv', header = FALSE)
