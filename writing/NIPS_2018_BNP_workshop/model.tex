...
distinct species of iris in the world, indexed by $k=1,2,3,\ldots$, and only some
finite number of species are present in our observed dataset.  Let $z_n$ denote
