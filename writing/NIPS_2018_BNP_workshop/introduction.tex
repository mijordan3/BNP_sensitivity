...
Extrapolation in the VB set-up motivates the use of multiplicative perturbations to the
...
retain the non-linearity of easily computed quantities as functions of the global parameters.
