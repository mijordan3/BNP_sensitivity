...
z \vert y \right)$.
Define
$H := \partial^2 KL(\eta_\theta, \epsilon) / \partial \eta_\theta \partial \eta^T
    \Big\rvert_{\eta_\theta = \etathetaopt, \epsilon = 0}$ and
$f_\eta := \partial^2
    \Expect_{q\left(\theta, z \vert \eta\right)}
        \left[ \log p\left(y, \theta, z \vert \epsilon \right) \right]
    / \partial \eta_\theta \partial \epsilon^T
    \Big\rvert_{\eta_\theta = \etathetaopt, \epsilon = 0}$.  Then
%
\begin{align}
