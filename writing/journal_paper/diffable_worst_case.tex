...
space of prior densities, as illustrated by \exref{infl_univariate}.  This
...
\corref{etafun_deriv_form}.  In particular, we observe that $\phi$ is a member
...
can use results such as \corref{etafun_worst_case} without producing
