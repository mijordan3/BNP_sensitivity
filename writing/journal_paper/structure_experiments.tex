...
$\expect{\q}{\pi_\n}$ for all individuals $\n$. 
The approximate posterior was fit to a model with a
...
For example,
while Mbololo individuals are dominantly population 1,
several individuals have abnormally large admixture proportions of population 2. Conversely, while Ngangao individuals are dominantly population 2, 
several individuals have abnormally large admixture
...
individuals hightlighted as ``A," ``B", or ``C" 
in the top row of \figref{stru_func_sens}:
$\mathcal{N} = \{26, ..., 31\}$ and $k = 2$,
corresponding to the six Mbololo individuals with outlying proportions of population 2;
$\mathcal{N} = \{125, ..., 128\}$ and $k = 1$,
corresponding to the four Ngangao individuals with outlying proportions of population 1;
$\mathcal{N} = \{139, ..., 155\}$ and $k = 3$,
corresponding to all Chawia individuals.
...
non-robust. 
On the other hand, the admixture of population 1 in individuals ``B" are robust.
