...
\caption[The expected number of loci per cluster as $\alpha$ varies]{The expected number of loci per cluster as $\alpha$ varies. 
    ...
    expected number of thresholded clusters in \fig{stru_alpha_nclusters} }\label{fig:stru_alpha_cluster_weights}
\end{figure}
...
{\centering \includegraphics[width=0.980\linewidth,height=1.019\linewidth]{figure/stru_func_sens-1} 
