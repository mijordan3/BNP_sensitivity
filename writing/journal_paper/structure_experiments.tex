...
We employ the topic model from \exref{structure_generative_process}. 
...
Finally, the computational cost of linearizing the variational parameters is again favorable compared with refitting (\tabref{stru_timing}). 
Forming the linear approximation took less than half a second; 
as usual, subsequent evaluations of $\etalinglobal$ take milliseconds.
