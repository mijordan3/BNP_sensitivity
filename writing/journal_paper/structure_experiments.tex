...
We consider the range $\alpha = 0.5, 1, 2, \ldots 7$. 
...
$\gclusters(\etalinglobal(\alpha))$ for $\alpha = 1, \ldots, 7$. 
For this range of $\alpha$, the linearized parameters and the refitted parameters 
