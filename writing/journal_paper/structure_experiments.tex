...
Let $\x_{\n\l\i}\in\{1, \ldots, J\}$ be the observed genotype for
individual $\n$ at locus $\l$ and chromosome $\i$. 
Here, $J$ is the number of possible genotypes.
...
The distribution of the observed genotype $\x_{\n\l\i}\in\{1, \ldots, J\}$ depends on its population assignment. Here, the components variables $\beta_\k$ 
...
The resulting inference from our BNP model is qualitatively similar to the results reported in \citet{pritchard:2000:structure}, who employed a related model called STRUCTURE. 
...
(We also will use ``population" interchangably with ``cluster",
in this application). 
