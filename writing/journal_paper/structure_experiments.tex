...
$20.7$, 
and a new cluster emerges above the threshold at $t = 20$. 
On the other hand, at $\alpha = 1$, 
the expected number of loci belonging to population 3 decreases 
$6.7$, 
...
{\centering \includegraphics[width=0.980\linewidth,height=0.627\linewidth]{figure/stru_lin_bad_example-1} 
...
{\centering \includegraphics[width=0.980\linewidth,height=0.627\linewidth]{figure/stru_fully_lin_example-1} 
