...
In the \secref{valid_priors}, we proved that directional derivatives exist, at
least for all perturbations of the form given by \defref{prior_nl_pert}.
...
We now turn to the more expressive case when $p \in [1, \infty)$. Note that
