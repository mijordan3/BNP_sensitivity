...
\section{Additional experiment illustrations}
\applabel{app_results}
We give some additional illustrations for each experiment.

    \subsection{Gaussian mixture modeling on iris data}
    \applabel{app_results_iris}
    \input{app_results_iris.tex}

    \subsection{Regression mixture modeling}
    \applabel{app_results_mice}
    \input{app_results_mice.tex}

    \subsection{Genetic admixture modeling with fastSTRUCTURE}
    \applabel{app_results_structure}
    \input{app_results_structure.tex}
