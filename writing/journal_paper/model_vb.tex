...
Kullback-Leibler (KL) divergence to the exact posterior. \todo{I think the KL
divergence isn't well defined between the truncation and the truth, but I don't
think that KL divergences are inherently ill-defined for infinite dimensional
spaces.} One approach to apply VB to Dirichlet process stick-breaking models
