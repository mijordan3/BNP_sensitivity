...
under $\q$, we will allow conditional dependence between $\z$ and $\b$ \secref{appendix}.
...
Using the densities displayed in \exref{iris_bnp_process},
...
study more closely in \secref{results}. We will evaluate the sensitivity
...
Secondly, in \secref{influnce_section}, it will be useful to evaluate the
