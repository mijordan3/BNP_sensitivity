...
conditional on the fixed $m$ uniform draws, $\g$ will be a deteriministic function
of $\eta$, and we can compare how $\g$ changes without stochasticity.
Secondly, in \secref{funcional_perturbations}, it will be useful to evaluate the
