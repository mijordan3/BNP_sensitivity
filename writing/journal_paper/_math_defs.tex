...
\def\qk{\q_k}   % VB dist, just the kth stick-breaking component
...
\def\betadist#1{\mathrm{Beta}\left(#1\right)}   % beta distribution
\def\unifdist#1{\mathrm{Unif}\left[#1\right]}   % uniform distribution
