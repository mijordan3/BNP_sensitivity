...
\Assuref{dist_fun_nice} states sufficient conditions for which we can
...
%
Let \assuref{dist_fun_nice} hold for some $\psi$ as well as with $\psi(\zeta,
\t) = 1$.  Then
%
\begin{align*}
%
...
\assuitemref{kl_opt_ok}{q_stick_regular} (ultimately via \assuref{q_regular})
and $\ball_\t$ is given in \assuref{prior_pert_smooth}.  Let
%
\begin{align*}
%
\KLgrad{\eta, \t} :={}&
