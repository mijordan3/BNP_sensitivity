...
approximation given in \secref{model_vb} under the following
\assuref{kl_opt_ok}, which is satisfied for any local optimum of a smooth,
...
% }
%
Under the VB approximation of \secref{model_vb}, \assuref{kl_opt_ok}, and with
