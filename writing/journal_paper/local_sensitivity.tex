...
the variatioanl objective.  The details can be found in \lemref{logq_derivs,
...
%
    ...
    \assuref{dist_fun_nice} with $\eta_0 = \etaopt$, with $\psi(\zeta, \t) = 1$,
...
%
Let \assuref{kl_opt_ok} hold.  Then the map $\t \mapsto
...
By \lemref{logq_continuous} and \assuitemref{kl_opt_ok}{q_stick_regular}, we
...
Together with \assuitemref{kl_opt_ok}{kl_hess}, the result then follows from the
implicit function theorem \citet[Theorem 3.3.1]{krantz:2012:implicit}.  Note
