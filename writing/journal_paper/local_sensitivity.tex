...
\end{equation}
%
In \thmref{bnp_deriv}, we show that $\t \mapsto \etaopt(\t)$ is continuously
...
$t$ when $\norminf{\phi} < \infty$. The $\norminf{\cdot}$ norm has further
connections to multiplicative perturbations, as discussed in
\citep{gustafson:1996:marginal} and later in \secref{influence_function}.
