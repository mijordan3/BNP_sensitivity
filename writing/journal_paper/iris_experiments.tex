...
\caption[Probability density functions of $\text{Beta}(1, \alpha)$ distributions, under various $\alpha$ considered for the iris data set]{Probability density functions of $\text{Beta}(1, \alpha)$ distributions, under various $\alpha$ considered for the iris data set.  Note the change in y-axis scale.}\label{fig:beta_priors}
\end{figure}
...
\caption[The expected number of clusters as $\alpha$ varies in thethe GMM fit of the iris data.On the left is in-sample quantity $\gclustersabbr$.On the right is the the predictive quantity $\gclusterspredabbr$.We formed the linear approximation at $\alpha=2$]{The expected number of clusters as $\alpha$ varies in thethe GMM fit of the iris data.On the left is in-sample quantity $\gclustersabbr$.On the right is the the predictive quantity $\gclusterspredabbr$.We formed the linear approximation at $\alpha=2$.}\label{fig:iris_alpha_sens}
\end{figure}
...
$\norminf{\phi} = 1$, as in REFERENCEWHENWRITTEN.  The middle column of
...
robust quantity for this model and dataset.
...
given functional perturbation required 0.03 seconds. A refit using $\palt$ in place of $\pbase$ requires about
