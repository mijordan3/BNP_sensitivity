...
\subsubsection*{The Jacobian term}

\todo{Move the discussion about the cross-hessian earlier: maybe after corollary 1.}

We give the expectation in the local sensitivity computation
(\eqref{vb_eta_sens}) a name. Define
\begin{align*}
...
\end{align*}
and we write out this expectation in the context of a stick-breaking prior.
