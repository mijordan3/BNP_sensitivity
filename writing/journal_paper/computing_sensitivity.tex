\todo{maybe put details about optimization here. first step to compute sensitivity is to find the optimum after all ...
in general, see if we can move some stuff from results intro here. }
