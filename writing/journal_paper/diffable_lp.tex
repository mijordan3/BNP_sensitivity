...
perturbations, as we dicuss in \appref{positive_pert}.

However, we must acknolwedge that our \thmref{kl_discontinuous} below relies on
...
\thmref{kl_discontinuous}. In the view of the authors, restricting to pointwise
...
Consider \figref{func_dist}, which succinctly summarizes the tradeoffs.  The two
