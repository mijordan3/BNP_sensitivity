...
% \todo{Do these sentences move us forward here?}
% For these applications, we thus would like a
% similarly quick, possibly approximate, method to assess the sensitivity of the
% VB posterior to prior choices. Assessing sensitivity is especially important
