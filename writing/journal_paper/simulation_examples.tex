...
\caption[Left two figures]{Left two figures: An multiplicative ball $\ball_\phi(\delta)$.  Right figure: Two densities which are distant according to KL divergence and $\norminf{\cdot}$ but close according to $\norm{\cdot}_p$ for $p \in [1, \infty)$.}\label{fig:linf_examples}
\end{figure}
