...
$\pbase$, as shown in \figref{linf_examples}.
...
Although
\lemref{pert_invariance} of \appref{diffable_nonparametric} proves that every
$\phi$ with $\norminf{\phi}$ is a valid prior, the converse is not true. For
instance, perturbing the beta stick-breaking form by changing $\alpha$ provides
a counterexample; see \exref{beta_inf_norm} for more details. \todo{Make sure
this works with the corrected \defref{prior_nl_pert} }
