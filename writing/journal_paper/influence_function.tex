...
\begin{proof}
%
Our result here is a special case of the general result, across models and
parameters with a VB posterior approximation, in \thmref{eta_phi_deriv}
of \appref{diffable_worst_case}.
%
\end{proof}
