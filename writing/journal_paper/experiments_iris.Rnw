...
column, we plot the influence function in the logit space in purple. According
to \corref{etafun_deriv_form}, the sign and magnitude of the effect of a
perturbation should be determined by its integral against the influence
