...
\\coryref{{etafun_deriv_form}.  For ease of visualization, we show the influence
...
According to \\coryref{{etafun_deriv_form}, the sign and magnitude of the effect of
...
\\coryref{{etafun_deriv_form} confirms that this intuition holds, both for
