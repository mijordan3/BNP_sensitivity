...
gene_initial_coclustering_cap <- paste(
    "The inferred co-clustering of gene expressions at $\\alpha = 6.$ ")
...
\Sexpr{sprintf("%.3f", maxdiff_alpha1)} and 
\Sexpr{sprintf("%.3f", maxdiff_alpha11)}, respectively. 
...
gene_alpha_coclustering_cap <-
    paste0("Changes in the co-clustering matrix at alpha = 1 (top row)
     ...
     relative to the co-clustering matrix at alpha = 6.
