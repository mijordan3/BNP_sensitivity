...
%
$
The $\beta_\k$ in turn are generated i.i.d.\ from a prior $\pbetaprior(\beta_\k)$. For instance, in a Gaussian mixture model, $\beta_\k$ could be a vector describing the mean and covariance of a Gaussian distribution (e.g.\ as in \exref{iris_bnp_process} in \appref{gmm_example}).
