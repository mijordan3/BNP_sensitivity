...
%
First, consider \itemref{perts_are_priors}. It is clear that
...
\end{align*}
%
This concludes the proof of \itemref{perts_are_priors}.

For \itemref{perts_vs_ball_p}, we show that, when $p \in [1, \infty)$ and
