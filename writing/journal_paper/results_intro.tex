...
\todo{Here it would be good to say more explicitly that you
choose an alpha range and re-fit the model on a grid of alphas.
Then in each experiment you can just present the result with no additional
commentary.}


\todo{This paragraph could go somewhere less prominent.}
...
\todo{Cite the details of the trust-ncg algorithm, nobody will know what that means}
...
\todo{This paragraph should go in the Computing the Sensitivity section.}
