...
\Assuref{exchange_order_dom} implies \assuref{exchange_order}.  Thus, both
\assuref{kl_opt_ok, exchange_order}  are satisfied, and \thmref{etat_deriv}
applies to the map $\alpha \mapsto \etaopt(\alpha)$.
