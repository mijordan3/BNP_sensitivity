...
%
Let \assuref{exchange_order_dom} hold for some.  Define
%
\begin{align*}
%
...
%
\todo{Adapt this proof to the general statement \lemref{exchange_order}.}

Let \assuref{exchange_order_dom} hold.  Then
%
\begin{align*}
%
