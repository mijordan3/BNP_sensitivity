...
\begin{enumerate}
%
% \item  \itemlabel}, {fundiffab The map $\t \mapsto \psi(\zeta, \t)$ is
% continuously differentiable.
%
...
%
Let \assuref{dist_fun_nice} hold with $\psi(\zeta, \t) = 1$.
...
% is twice continuously differentiable.
% %
% \item \itemlabel{fundom} For all $\eta \in \ball_\eta$, $\q(\zeta \vert \eta) \le
% M(\zeta)$.
% %
% \item \itemlabel{funqgraddom} For all $\eta \in \ball_\eta$, $\q(\zeta \vert \eta)
% \norm{\lqgrad{\zeta \vert \eta}}_2 \le M(\zeta)$.
% %
% \item \itemlabel{funqhessdom} For all $\eta \in \ball_\eta$, $\q(\zeta \vert \eta)
% \norm{\lqhess{\zeta \vert \eta}}_2 \le M(\zeta)$.
% %
% \item \itemlabel{funqgradsqdom} For all $\eta \in \ball_\eta$, $\q(\zeta \vert \eta)
...
%
Let \assuref{dist_fun_nice, dist_nice} hold.  Define
%
\begin{align*}
%
