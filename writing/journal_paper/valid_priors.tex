...
We must ask however: do all $\phi \in \ball_{\mu,p}(\delta)$ correspond to
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{lem}\lemlabel{pertset_bounded_below}
%
...
\Thmref{lp_derivative}, together with \lemref{pertset_bounded_below}, tells us
...
priors.  In this sense, one might be tempted to employ \thmref{lp_derivative}
