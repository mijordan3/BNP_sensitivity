...
def load_fs_to_vb_params(filename): 
    ...
    vb_params_dict['pop_freq_beta_params'] = onp.array(vb_params_dict['pop_freq_beta_params'])
    vb_params_dict['ind_mix_stick_beta_params'] = onp.array(vb_params_dict['ind_mix_stick_beta_params'])
    ...
    vb_params_dict['ind_mix_stick_beta_params'][:, :, 0] = ind_admix_var[:, 0:(k_approx-1)]
    vb_params_dict['ind_mix_stick_beta_params'][:, :, 1] = betas[:, 1:]
