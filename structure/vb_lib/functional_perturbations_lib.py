...
class FunctionalPerturbation(): 
    ...
    self.e_log_phi_epsilon = lambda means, info, epsilon : \
                        epsilon * e_log_phi
    ...
    def e_log_phi_epsilon(self, means, infos, epsilon): 
        ...
        return epsilon * e_log_phi(means, infos)
    ...
    def hyper_par_objective_fun(self,
        ...
        return - self.e_log_phi(means, infos, epsilon)
